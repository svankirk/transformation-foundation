        ...
        <form  id="applyEntryForm" name="applyEntryForm" action="">
            ...
            <p> 
             <h2> Administrative Section</h2>
               ...
               <input type="date" name="adminDateCreated" disabled>
             </p>
             <p>
                <label for='adminAssignedTo' >Assigned To:</label>
                <input type="text" class="mSize" name="adminAssignedTo" disabled>
            </p>
            <p>
                <label for='adminAssignedDate'>Assigned Date:</label>
                <input type="date" name="adminAssignedDate" disabled>
            </p>
            <p>
                ...
                <input type="date" name="adminOneMonFollowDate" disabled >
            </p>
            <p>
            ...
            <p>
                ...
                <input type="date" name="adminSixMonFollowDate" disabled >
            </p>
            <p>
